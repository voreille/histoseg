"""
Adapter modules for ViT multi-scale feature extraction.

Contains all the adapter-specific components including deformable attention,
spatial prior module, and interaction blocks.
"""
...
def deform_inputs(x):
    """Prepare deform inputs for multi-scale deformable attention."""
    bs, c, h, w = x.shape
...
class DWConv(nn.Module):
    """Depthwise Convolution for multi-scale features."""
...
class Extractor(nn.Module):
    """Feature extractor using multi-scale deformable attention."""
...
class Injector(nn.Module):
    """Multi-scale feature injector using deformable attention."""
...
class InteractionBlock(nn.Module):
    """Interaction block combining injection and extraction."""
...
class SpatialPriorModule(nn.Module):
    """Spatial Prior Module for multi-scale feature extraction."""
