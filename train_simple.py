...
from histoseg.data import PanNukeDataModule
...
def main():
    ...
    # Model configuration
    model = Mask2FormerModule(num_classes=5,
                              image_size=(256, 256),  # Smaller size for debugging
                              learning_rate=1e-4,
                              weight_decay=0.01)
    ...
    logger = TensorBoardLogger(save_dir="/home/val/workspaces/histoseg/logs",
                               name="debug_run")
